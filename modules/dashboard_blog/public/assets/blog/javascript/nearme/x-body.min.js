!(function(t) {
  t.fn.hoverIntent = function(e, i, s) {
    ...
    o =
      'object' == typeof e
        ? t.extend(o, e)
        : t.isFunction(i) ? t.extend(o, { over: e, out: i, selector: s }) : t.extend(o, { over: e, out: e, selector: i });
    var n,
      r,
      a,
      l,
      ...
      c = function(e, i) {
        return (
          ...
          Math.abs(a - n) + Math.abs(l - r) < o.sensitivity
            ? (t(i).off('mousemove.hoverIntent', h), (i.hoverIntent_s = 1), o.over.apply(i, [e]))
            : ((a = n),
              (l = r),
      ...
      d = function(e) {
        ...
        'mouseenter' == e.type
          ...
          : (t(s).off('mousemove.hoverIntent', h),
            1 == s.hoverIntent_s &&
                (s.hoverIntent_t = setTimeout(function() {
                  u(i, s);
                }, o.timeout)));
...
(function(t, e) {
  ...
  var i,
    ...
    l = function(t) {
      ...
      t = r(t);
      for (var s = 0, n = a.length; n > s; s++) if (((e = a[s] + t), 'string' == typeof i[e])) return e;
    },
    h = l('transform'),
  ...
  if (n) for (i in u) n.hasOwnProperty(i) || n.addTest(i, u[i]);
  else {
  ...
  (e.Isotope.prototype = {
      ...
      var t = this.options.sortBy,
        ...
        s = function(s, o) {
          var n = e(s, t),
            r = e(o, t);
          return (
            n === r && 'original-order' !== t && ((n = e(s, 'original-order')), (r = e(o, 'original-order'))),
            (n > r ? 1 : r > n ? -1 : 0) * i
          );
        };
    ...
    _pushPosition: function(t, e, i) {
      ...
      this.styleQueue.push({ $el: t, style: s }),
    ...
    remove: function(t, e) {
      ...
      t.filter(':not(.' + this.options.hiddenClass + ')').length
        ? (this.styleQueue.push({ $el: t, style: this.options.hiddenStyle }), this._sort(), this.reLayout(s))
        : s();
    },
    shuffle: function(t) {
    ...
    _fitRowsLayout: function(t) {
      ...
      t.each(function() {
        var t = e(this),
          n = t.outerWidth(!0),
          r = t.outerHeight(!0);
        0 !== o.x && n + o.x > s && ((o.x = 0), (o.y = o.height)),
        i._pushPosition(t, o.x, o.y),
    ...
    _cellsByRowLayout: function(t) {
      ...
      t.each(function() {
        var t = e(this),
          ...
          r = (o + 0.5) * s.columnWidth - t.outerWidth(!0) / 2,
          a = (n + 0.5) * s.rowHeight - t.outerHeight(!0) / 2;
    ...
    _fitColumnsLayout: function(t) {
      ...
      t.each(function() {
        var t = e(this),
          n = t.outerWidth(!0),
          r = t.outerHeight(!0);
        0 !== o.y && r + o.y > s && ((o.x = o.width), (o.y = 0)),
        i._pushPosition(t, o.x, o.y),
        (o.width = Math.max(o.x + n, o.width)),
        (o.y += r);
      });
    },
  ...
  (e.fn.imagesLoaded = function(t) {
    ...
    return (
      r || i(),
      n.bind('load.imagesLoaded error.imagesLoaded', s).each(function() {
        var t = this.src;
      ...
      this.each(function() {
        ...
        return i
          ? e.isFunction(i[t]) && '_' !== t.charAt(0)
            ? void i[t].apply(i, s)
            : void x("no such method '" + t + "' for isotope instance")
          : void x("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'");
      });
    } else
      this.each(function() {
...
(function(t, e, i) {
    ...
    if ('' == e.value) {
      if ('password' == e.type) {
        if (!n.data('placeholder-textinput')) {
          ...
          t
            .removeAttr('name')
            .data({ 'placeholder-password': n, 'placeholder-id': r })
            .bind('focus.placeholder', o),
          n.data({ 'placeholder-textinput': t, 'placeholder-id': r }).before(t);
        }
        n = n
          .removeAttr('id')
          .hide()
  ...
  var a,
    l,
    h = '[object OperaMini]' == Object.prototype.toString.call(t.operamini),
    ...
    : ((l = d.placeholder = function() {
      ...
      return (
        t
          ...
          .not('.placeholder')
          .bind({ 'focus.placeholder': o, 'blur.placeholder': n })
        ...
        set: function(t, e) {
          ...
          return a
            ...
            : s.data('placeholder-enabled')
              ? ('' == e
                ? ((t.value = e), t != r() && n.call(t))
                : s.hasClass('placeholder') ? o.call(t, !0, e) || (t.value = e) : (t.value = e),
                s)
              : (t.value = e);
        }
      }),
      c || ((f.input = a), (p.value = a)),
      u || ((f.textarea = a), (p.value = a)),
      i(function() {
...
+(function(t) {
  ...
  function e(i, s) {
    var o,
      n = t.proxy(this.process, this);
    (this.$element = t(t(i).is('body') ? window : i)),
    (this.$body = t('body')),
    (this.$scrollElement = this.$element.on('scroll.bs.scroll-spy.data-api', n)),
    (this.options = t.extend({}, e.DEFAULTS, s)),
    (this.selector =
          (this.options.target || ((o = t(i).attr('href')) && o.replace(/.*(?=#[^\s]+$)/, '')) || '') + ' .x-nav li > a'),
    (this.offsets = t([])),
    (this.targets = t([])),
      ...
      this.$body
        ...
        .map(function() {
          var s = t(this),
            ...
            n = /^#\w/.test(o) && t(o);
          return (
            (n && n.length && [[n[e]().top + (!t.isWindow(i.$scrollElement.get(0)) && i.$scrollElement.scrollTop()), o]]) ||
                null
          );
        })
        .sort(function(t, e) {
  ...
  (e.prototype.activate = function(e) {
    ...
    s.parent('.dropdown-menu').length && (s = s.closest('li.dropdown').addClass('current-menu-item')),
...
jQuery(document).ready(function(t) {
  function e(e, i, s) {
    t('html, body').animate({ scrollTop: t(e).offset().top - o - n + 1 }, i, s);
  }
  var i = t('body'),
    s = i.outerHeight(),
  ...
  if (
      ...
      t('a[href*="#"]').on('touchstart click', function(i) {
        if (
          (($href = t(this).attr('href')),
            (notComments = -1 === $href.indexOf('#comments')),
            (notAccordion = -1 === $href.indexOf('#collapse-')),
            (notTabbedContent = -1 === $href.indexOf('#tab-')),
            '#' !== $href && notComments && notAccordion && notTabbedContent)
        ) {
    ...
    i.scrollspy({ target: '.x-nav-wrap.desktop', offset: o + n }),
...
jQuery(function(t) {
  t('.x-slider-container.above .x-slider-scroll-bottom').on('touchstart click', function(e) {
    e.preventDefault(),
    t('html, body').animate({ scrollTop: t('.x-slider-container.above').outerHeight() }, 850, 'easeInOutExpo');
  }),
  t('.x-slider-container.below .x-slider-scroll-bottom').on('touchstart click', function(e) {
    ...
    var i = t('.masthead').outerHeight(),
      ...
      r = i + o + n - s;
    t('html, body').animate({ scrollTop: r }, 850, 'easeInOutExpo');
  });
});
