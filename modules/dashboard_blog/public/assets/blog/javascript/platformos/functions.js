        ...
        $fullScreenEl.each(function() {
          ...
          if (element.attr('id') == 'slider') {
            ...
            if (element.find('.slider-parallax-inner').length > 0) {
              ...
              scrHeight =
                (window.innerHeight ? window.innerHeight : $window.height()) + Number(transformXvalue) - sliderHeightOff;
            }
            if (
      ...
      if (lazyLoadEl.length > 0) {
        lazyLoadEl.each(function() {
          var element = $(this),
            ...
            preloader = __cdnUrl() + 'images/platformos/preloader.gif'; // i was trying to access this file and it doesnt exist...

          element.attr('src', 'images/blank.svg').css({ background: 'url() no-repeat center center #FFF' });
                ...
                if (slideNumberCurrent.length > 0) {
                  if (elementLoop == true) {
                    slideNumberCurrent.html(
                      Number(element.find('.swiper-slide.swiper-slide-active').attr('data-swiper-slide-index')) + 1
                    );
                  } else {
                ...
                element.find('.swiper-slide:not(".swiper-slide-active")').each(function() {
                  ...
                  if (slideEl.find('.yt-bg-player.mb_YTPlayer:not(.customjs)').length > 0) {
                    slideEl
                      ...
                      .YTPGetPlayer()
                      .seekTo(slideEl.find('.yt-bg-player.mb_YTPlayer:not(.customjs)').attr('data-start'));
                  }
                });
    ...
    contactForm: function() {
      ...
      $contactForm.each(function() {
        var element = $(this),
          ...
          elementResultSuccessMessage = element.find('.contact-form-result').attr('data-message'),
        ...
        element.find('form').validate({
          submitHandler: function(form) {
            ...
            if (elementLoader == 'button') {
              ...
              defButton.html('<i class="icon-line-loader icon-spin nomargin"></i> Sending...');
            } else {
              $(form)
                .find('.form-process')
                .fadeIn();
              ...
              success: function(data) {
                ...
                if (elementAlert == 'inline') {
                  ...
                  elementResult
                    ...
                    .html(elementResultSuccessMessage)
                    .slideDown(400);
                  $(form).slideUp(400);
                } else {
                  elementResult
