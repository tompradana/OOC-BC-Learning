webpackJsonp([0], {
  /***/ 11: /***/ function(module, exports, __webpack_require__) {
    ...
    (function(navigator, window, document, $) {
      ...
      Trumbowyg.prototype = {
          ...
          if (t.o.semantic) {
            ...
            if (full) {
              ...
              t.$ed
                ...
                .filter(function() {
                  return (
                    this.nodeType === 3 && this.nodeValue.trim().length > 0
                  );
                })
                .wrap('<span data-tbw/>');

              // Wrap groups of inline elements in paragraphs (recursive)
              var wrapInlinesInParagraphsFrom = function wrapInlinesInParagraphsFrom(
                $from,
              ) {
                if ($from.length !== 0) {
        ...
        semanticTag: function semanticTag(oldTag, newTag, copyAttributes) {
  ...
  /***/ 2: /***/ function(module, exports, __webpack_require__) {
    ...
    /* WEBPACK VAR INJECTION */ (function($) {
      ...
      $.trumbowyg.svgPath = ''.concat(__cdnUrl(), 'images/trumbowyg-icons.svg');
